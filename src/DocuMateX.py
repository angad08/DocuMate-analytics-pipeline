"""
====================================================================
 DocuMateX v4.0 / X — Birth Registration
====================================================================
...
class BirthRegistrationProcessor:
    ...
    def load_data(self):
        ...
        self.data = [
            {
                "Serial": str(r[0]) +"/"+str(current_year),
                "Name": r[1],
                "Sex": r[2],
                "When_and_where_born":(r[3].strftime("%d/%m/%Y") if hasattr(r[3], "strftime") else str(r[3])) + ", " + r[4],
                "Name_of_the_Father": r[5],
                "Name_of_the_Mother": r[6],
                "Description_and_residence_of_informant": r[7],
                "Registration_date": r[8].strftime("%d/%m/%Y"),
                "MHA_File_And_date": r[9] + ", " + (r[10].strftime("%d/%m/%Y") if hasattr(r[10], "strftime") else str(r[10])),
                "Signing_Authority_Name": r[11],
                "Signing_Authority_Name_Designation": r[12],
                "year": current_year
            }
            for r in rows
        ]
    ...
    def run(self):
        ...
        try:
            ...
            # --- Generate & Merge ---
            print("⚙️ Processing Word documents...\n")
...
if __name__ == "__main__":
    ...
    # run once or loop based on the auto_detect setting [X]
    docuMateAgent.start()
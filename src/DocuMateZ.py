...
class BirthRegistrationProcessor:
    ...
    def run(self):
        ...
        try:
            ...
            self.generate_and_merge_documents(merged_filename=f"DocuMateZ_BIRTH_REGISTRATION_{datetime.now().strftime('%d%m%Y_%H%M%S')}.docx")
...
if __name__ == "__main__":
    ...
    db_config = {
        ...
        "password": "REDACTED-ROTATED-CREDENTIAL",             # <- put your DB password
        "port": 5432,
        "sslmode": "require"
    }
